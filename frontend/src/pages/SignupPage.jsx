    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 font-sans selection:bg-jb-accent selection:text-white overflow-hidden text-slate-800">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Join the next-gen cognitive platform</p>
        </div>
        ...
        <div className="bg-jb-card/80 backdrop-blur-xl border border-jb-border rounded-3xl p-8 shadow-[0_8px_30px_rgba(13,148,136,0.1)] relative overflow-hidden group">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2 relative">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User className="h-5 w-5 text-slate-400 group-focus-within:text-jb-accent transition-colors" />
                </div>
                <input
                  type="text"
                  name="name"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white py-4 rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed mt-6"
            >
              {loading ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-500 text-sm">
              ...
              <Link to="/login" className="text-jb-accent font-semibold hover:underline flex items-center justify-center gap-1 inline-flex">
